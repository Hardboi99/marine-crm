...
const ROLE_DEFAULT_DEPARTMENT = {
  ...
  [ROLES.CREWING_MANAGER]: DEPARTMENTS.CREWING,
  [ROLES.CREWING_OFFICER]: DEPARTMENTS.CREWING,
...
const ROLE_GROUPS = {
  ...
  ANY_MANAGER: [ROLES.DIRECTOR, ROLES.COO, ROLES.CREWING_MANAGER, ROLES.SOURCING_MANAGER, ROLES.DOCUMENTATION_MANAGER, ROLES.ADMIN],
  SOURCING: [ROLES.SOURCING_MANAGER, ROLES.SOURCING_OFFICER, ROLES.CREWING_MANAGER, ROLES.CREWING_OFFICER],
  CREWING: [ROLES.CREWING_MANAGER, ROLES.CREWING_OFFICER, ROLES.SOURCING_MANAGER, ROLES.SOURCING_OFFICER],
