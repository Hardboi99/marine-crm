// // Birthday Celebration Widget — Marine BDM CRM (Premium Edition)
// // ------------------------------------------------------------------
...
// //      (bottom-right desktop, bottom-center mobile) — structure kept
// //      intact from the previous version.
...
// //      the works. If there are multiple "today" birthdays, arrows/
// //      dots let you step through each of them.
// //   3. Clicking ANY birthday card in the panel (today or upcoming)
// //      opens the same popup for that specific person. Confetti/
// //      balloons only fire for an actual "today" birthday; upcoming
// //      birthdays get a clean, calm version of the same popup.
...
//       // Card click/tap → open the same celebration popup for that person
...
//         // MAIN REQUIREMENT: auto-show the celebration popup as soon as
//         // the page loads whenever there's a birthday today.
